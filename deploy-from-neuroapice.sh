...
FUNCTION_DIRS="church-art-generate church-art-generate-google download-video generate-chat-follow-ups generate-content generic-ai-chat get-google-models get-openai-models get-openrouter-models get-video-metadata neurodesign-generate neurodesign-generate-google neurodesign-refine neurodesign-refine-google neuroflow-generate-video-veo neuroflow-list-models neuroflow-video-download page-analyzer site-builder-assistant keyword-planner"
